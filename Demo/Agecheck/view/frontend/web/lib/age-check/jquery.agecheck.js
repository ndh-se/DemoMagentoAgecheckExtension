...
(function ($){   
    ...
    $.ageCheck = function(options) {
        ...
        var _this = {
            ...
            //},
			/*
			 * alternate method for saving agecheck
			 */
			setCookie: function(key, val) {
				console.log('setting cookie1');
				try {
					var expDate = new Date();
					expDate.setFullYear(expDate.getFullYear() + 100);
					var cookieString = key + "=" + val + ";expires=" + expDate.toUTCString();
        ...
        $('.ac-container button').on('click', function(){
            ...
            if (_this.validate() === true) {
                ...
                if(_this.age >= settings.minAge){
					...
					if(!_this.setCookie("ageVerified", "true")){
                       alert('Cookie not supported by your browser');
                    };
                    _this.handleSuccess();
                }else{
